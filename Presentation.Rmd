...
| ------ | -------- | ----------- |
| AHRQ | [NHQR/NHDR Web Site](https://nhqrnet.ahrq.gov/inhqrdr/Alaska/dashboard) | State dashboards and benchmarks |
| AHRQ | [Medical Expenditure Panel Survey (MEPS)](https://meps.ahrq.gov/mepstrends/hc_care/) | Easy access (R code included), broad coverage |
| CMS | Medicare Compare | Easy access, quality assessment included. |
| CDC | [National Vital Statistics System](https://www.cdc.gov/nchs/nvss/index.htm) | General data (mortality rate, life expectancy etc.) |
